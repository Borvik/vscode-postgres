...
export class ColumnNode implements INode {
  ...
  constructor(private readonly connection: IConnection, private readonly schemaname: string, private readonly tablename: string, private readonly column: IColumn) {}
